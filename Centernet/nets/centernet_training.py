...
def loss(args):
    #-----------------------------------------------------------------------------------------------------------------#
    #   hm_pred：Prediction of heat map     (batch_size, 128, 128, num_classes)
    #   wh_pred：Prediction of width and height         (batch_size, 128, 128, 2)
    #   reg_pred：Prediction of center coordinate offset (batch_size, 128, 128, 2)
    #   hm_true：Precision of heat map       (batch_size, 128, 128, num_classes)
    #   wh_true：Precision of width and height         (batch_size, max_objects, 2)
    #   reg_true：Precision of center coordinate offset  (batch_size, max_objects, 2)
    #   reg_mask：Mask of precision       (batch_size, max_objects)
    #   indices：Coordinate of precision     (batch_size, max_objects)
    #-----------------------------------------------------------------------------------------------------------------#
