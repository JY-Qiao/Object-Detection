...
def yolo_head(feats, anchors, num_classes, input_shape, calc_loss=False):
    ...
    #---------------------------------------------------#
    #   Resize the predicted result to (batch_size,13,13,3,85)
    #   85 = 4 + 1 + 80
    #   4:Center width and height adjustment parameters
    #   1:Box confidence
    #   80:Class confidence
    #---------------------------------------------------#
    ...
    #---------------------------------------------------#
    #   box_xy:The center point of the box
...
def yolo_correct_boxes(box_xy, box_wh, input_shape, image_shape):
    ...
    #-----------------------------------------------------------------#
    #   offset:The offset of the effective area of ​​the image relative to the upper left corner of the image
    #   new_shape:The zoom situation of width and height
    #-----------------------------------------------------------------#
