...
def yolo_loss(loss_input):
    ...
    loss_13, loss_xy_13, loss_wh_13, loss_con_13, loss_class_13, loss_ciou_13 = \
        lossCalculator(y_trues[0], y_pres[0], anchors[0], input_size, object_scale, unobj_scale, thresh)

    loss_26, loss_xy_26, loss_wh_26, loss_con_26, loss_class_26, loss_ciou_26 = \
        lossCalculator(y_trues[1], y_pres[1], anchors[1], input_size, object_scale, unobj_scale, thresh)

    loss_52, loss_xy_52, loss_wh_52, loss_con_52, loss_class_52, loss_ciou_52 = \
...
#######################################################测试用代码#########################################################
# y_trues = [np.ones((1,13,13,3,25)), np.ones((1,26,26,3,25)), np.ones((1,52,52,3,25))]
# y_pres = [np.ones((1,13,13,75)) * 2, np.ones((1,26,26,75)) * 2, np.ones((1,52,52,75)) * 2]
